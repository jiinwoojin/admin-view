...
(function ($) {
  ...
  function TagsInput(element, options) {
    ...
    this.$input = $('<input type="text" class="form-control mb-1" placeholder="' + this.placeholderText + '"/>').appendTo(this.$container);
  ...
  TagsInput.prototype = {
    ...
    add: function(item, dontPushVal, options) {
      ...
      var $tag = $('<span class="' + htmlEncode(tagClass) + (itemTitle !== null ? ('" title="' + itemTitle) : '') + ' my-1 mx-1">' + htmlEncode(itemText) + '<span class="ml-1" style="cursor: pointer;" data-role="remove"><i class="fas fa-times"></i></span></span>');
      $tag.data('item', item);
