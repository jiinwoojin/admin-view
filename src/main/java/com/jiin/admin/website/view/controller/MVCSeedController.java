...
public class MVCSeedController {
    private static final String DUPLEX_CREATE_URI = String.format("/%s/proxy/create-seed-duplex", AdminViewServlet.CONTEXT_PATH);
    ...
    public Map<String, Object> proxySeedingCreate(HttpServletRequest request, @RequestParam Map<String, Object> param) {
        ...
        if (seedName.matches(String.format("%s-[0-9]*", DOCKER_SEED_NAME_PREFIX))) {
            ...
            Map<String, Object> map = duplexRESTComponent.sendDuplexRESTWithData(request, DUPLEX_CREATE_URI, strParam); // Neighbor 정보 저장
     ...
     */
    @ResponseBody
    @RequestMapping(value = "create-seed-duplex", method = RequestMethod.POST)
    public Map<String, Object> proxySeedingCreateDuplex(@RequestBody Map<String, Object> param) {
