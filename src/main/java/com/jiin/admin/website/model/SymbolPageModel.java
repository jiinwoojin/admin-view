...
@Getter
@Setter
public class SymbolPageModel extends PageModel {
    private String sDate; // Upload Start Date
    private String eDate; // Upload End Date

    public SymbolPageModel() {
        super();
        this.sDate = "";
        this.eDate = "";
    }

    public SymbolPageModel(int pg, int sz, int ob, int sb, String st, String sDate, String eDate) {
