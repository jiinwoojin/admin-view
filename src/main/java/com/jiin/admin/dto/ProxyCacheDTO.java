...
public class ProxyCacheDTO { // MyBatis Based DTO
    ...
    public ProxyCacheDTO(Long id, String name, Integer metaSizeX, Integer metaSizeY, Integer metaBuffer, List<ProxySourceDTO> sources, String cacheType, String cacheDirectory, Boolean selected){
        this.id = id;
        this.name = name;
